 ...
 */
/*! @defgroup window BaseWindow reference
...
/*! @brief BaseWindow iconification window attribute
 *
 *  BaseWindow iconification [window attribute](@ref GLFW_ICONIFIED_attrib).
 */
#define GLFW_ICONIFIED              0x00020002
/*! @brief BaseWindow resize-ability window hint and attribute
 *
 *  BaseWindow resize-ability [window hint](@ref GLFW_RESIZABLE_hint) and
 *  [window attribute](@ref GLFW_RESIZABLE_attrib).
 */
#define GLFW_RESIZABLE              0x00020003
/*! @brief BaseWindow visibility window hint and attribute
 *
 *  BaseWindow visibility [window hint](@ref GLFW_VISIBLE_hint) and
 *  [window attribute](@ref GLFW_VISIBLE_attrib).
 */
#define GLFW_VISIBLE                0x00020004
/*! @brief BaseWindow decoration window hint and attribute
 *
 *  BaseWindow decoration [window hint](@ref GLFW_DECORATED_hint) and
 *  [window attribute](@ref GLFW_DECORATED_attrib).
 */
#define GLFW_DECORATED              0x00020005
/*! @brief BaseWindow auto-iconification window hint and attribute
 *
 *  BaseWindow auto-iconification [window hint](@ref GLFW_AUTO_ICONIFY_hint) and
 *  [window attribute](@ref GLFW_AUTO_ICONIFY_attrib).
 */
#define GLFW_AUTO_ICONIFY           0x00020006
/*! @brief BaseWindow decoration window hint and attribute
 *
 *  BaseWindow decoration [window hint](@ref GLFW_FLOATING_hint) and
 *  [window attribute](@ref GLFW_FLOATING_attrib).
 */
#define GLFW_FLOATING               0x00020007
/*! @brief BaseWindow maximization window hint and attribute
 *
 *  BaseWindow maximization [window hint](@ref GLFW_MAXIMIZED_hint) and
...
/*! @brief BaseWindow framebuffer transparency hint and attribute
 *
 *  BaseWindow framebuffer transparency
...
/*! @brief BaseWindow content area scaling window
 *  [window hint](@ref GLFW_SCALE_TO_MONITOR).
 */
#define GLFW_SCALE_TO_MONITOR       0x0002200C
/*! @brief BaseWindow framebuffer scaling
 ...
 *
 *  BaseWindow systems put limits on window sizes.  Very large or very small window
 ...
 *
 *  @remark @win32 BaseWindow creation will fail if the Microsoft GDI software
